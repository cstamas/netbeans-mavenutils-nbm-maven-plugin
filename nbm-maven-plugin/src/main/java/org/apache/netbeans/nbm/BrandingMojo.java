 ...
 * format of branding resources is the same as in NetBeans Ant-based projects.
 *
 * The <code>src/main/nbm-branding</code> folder of the project is assumed to
 * contain the branding content. Within the directory, the following folder
 ...
 * </li><li>
 * 2. locate the jar within the IDE/platform installation and it's cluster, eg.
 ...
 * modules/org-openide-windows.jar
 * </li><li>
 * 4. within that folder place your branding modifications at the same location,
 * as if they were withn the jar, eg. org/openide/windows/ui/Bundle.properties
 * and place the changed bundle keys there.
 * </li></ul>
 *
 * @author Milos Kleint
 *
...
public final class BrandingMojo extends AbstractNbmMojo {
     ...
     * {@code nbmBuildDir} does not exist and the mojo is thus skipped.
     */
    ...
    @Inject
    public BrandingMojo(RepositorySystem repositorySystem, MavenSession mavenSession, MavenProjectHelper mavenProjectHelper, Artifacts artifacts) {
